...
document.addEventListener("DOMContentLoaded", function() {
    ...
    $.ajax({
        ...
        success: function(data) {
            //const darkMode = data.dark_mode ? 'dark' : 'light';
            //console.log("resultado de consulta ajax: ", darkMode);
...
function setTheme(themeValue) {
    ...
    // Llama a la función que cambia el resto de los elementos del navBar
...
function editThemeToggleMenu(themeValue) {
    ...
    if (themeButton) {
        ...
        if (themeValue === "light") {
            ...
            //themeAutoCheckbox.style.display = "none";
...
function setBackgroundImageAndButtons(themeValue) {
    ...
    const iconos = {
        light: '/static/core/img/light/Logo_blanco_azul.png',
        dark: '/static/core/img/dark/Logo_azul_blanco.png',
      };
...
function editNavBar(themeValue) {
    ...
    if (themeValue === 'dark') {
        ...
        imgElement.setAttribute('src', '/static/core/img/dark/Isologotipo_transparente_dark.png');
    } else {
