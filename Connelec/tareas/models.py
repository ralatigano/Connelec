...
class Tareas(models.Model):
    ...
    encargado = models.ForeignKey(settings.AUTH_USER_MODEL, on_delete=models.CASCADE, default=None, blank=True, null=True)
    estado = models.CharField(max_length=30,choices=opciones_estado, default='Sin asignar')
    fecha_entrega = models.DateField(default=None, blank=True, null=True)
    proyecto = models.ForeignKey("proyectos.Proyectos", on_delete=models.CASCADE, default=None, blank=True, null=True)
...
class Entrada_historial(models.Model):
    ...
    proyecto = models.ForeignKey("proyectos.Proyectos", on_delete=models.CASCADE)
...
class Archivos(models.Model):
    ...
    archivo = models.FileField(upload_to='archivos/', blank=True, default=None, null=True)
    fecha_creacion = models.DateTimeField(auto_now_add=True)
